  ...
  return (
    <GradientCard variant="glass" padding="lg" className="backdrop-blur-xl">
      <GradientCardHeader className="text-center space-y-2">
        <motion.div
          className="mx-auto w-16 h-16 gradient-primary rounded-2xl flex items-center justify-center shadow-glow mb-4"
        ...
        <GradientCardTitle className="text-2xl">Welcome back</GradientCardTitle>
        <GradientCardDescription>
